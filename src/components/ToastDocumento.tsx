 ...
 */
export function ToastDocumento({ variante, onFechar }: ToastDocumentoProps) {
  ...
  return (
    <div
      ...
      className={
        erro
          ? "fixed bottom-6 left-1/2 z-[60] max-w-[min(100vw-2rem,28rem)] -translate-x-1/2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-center text-sm font-medium text-red-800 shadow-lg dark:border-red-800 dark:bg-red-900/50 dark:text-red-200"
