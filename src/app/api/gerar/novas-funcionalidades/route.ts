...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = `${instrucaoPadrao}Você é um especialista em documentação de software. Com base no contexto abaixo, gere uma DOCUMENTAÇÃO DE NOVAS FUNCIONALIDADES em Markdown, descrevendo o funcionamento para a equipe (incluindo QA).
